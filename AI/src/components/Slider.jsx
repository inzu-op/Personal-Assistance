        ...
        <>
            ...
            >
                <div className="w-full h-full flex flex-col">
                    ...
                    >
                        <i className={`fa-solid fa-right-from-bracket text-lg p-2 rounded-md transition duration-100 ${
                    ...
                    {isActive && (
                        <div className="flex-1 flex flex-col pl-3">
                            ...
                            >
                                <i className={`fa-solid fa-plus text-lg p-2 rounded-md transition duration-100 ${
                                    theme === "light" ? "hover:bg-[#F4DBEF]" : "hover:bg-gray-700"
                                }`}></i>
                                <h3 className={`ml-2 text-base animated-h3 ${isVisible ? 'visible' : ''}`}>
                                    New Chat
                                ...
                                <div className='mt-3 overflow-y-auto max-h-[40vh] custom-scrollbar overflow-x-hidden'>
                                    <ul className='list-none'>
                                        {conversations.map((conv, index) => (
                                            <li
                                                key={index}
                                                className={`text-sm rounded-lg p-3 flex items-center justify-between transition-all duration-200 group relative hover:pr-8 ${
                                            ...
                                            >
                                                ...
                                                <i 
                                                    className={`fa-solid fa-xmark absolute right-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-3 group-hover:translate-x-0 cursor-pointer p-2 rounded-md ${
                                                        theme === "light" ? "hover:bg-[#F4DBEF]" : "hover:bg-gray-700"
                                                    }`}
                            ...
                            <div className="setting flex items-center py-4 mt-auto mb-20">
                                <i className={`fa-solid fa-gear text-lg p-2 rounded-md transition duration-100 ${
                                    theme === "light" ? "hover:bg-[#F4DBEF]" : "hover:bg-gray-700"
                                }`}></i>
                                <h3 className={`ml-2 text-base animated-h3 ${isVisible ? 'visible' : ''}`}>
                                    Setting
            ...
            {showDeletePopup && (
                <div className="fixed inset-0 flex items-center justify-center z-50 animate-fadeIn">
                    ...
                    <div 
                        className={`${
                            theme === 'light' ? 'bg-white text-[#501854]' : 'bg-[#1D121A] text-white'
